...
shared_ptr<PhysXComponent> GameObject::GetPhysXComponent()
{
	shared_ptr<Component> component = GetFixedComponent(COMPONENT_TYPE::PHYSX);
	return static_pointer_cast<PhysXComponent>(component); // PhysXComponent
}
